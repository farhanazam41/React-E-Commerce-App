...
var _jsxFileName = "C:\\Users\\farha\\Desktop\\reacttest\\pages\\login.js";
...
function Login() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      setLoading(true);
      setError('');
      const url = `${_utils_baseUrl__WEBPACK_IMPORTED_MODULE_6__["default"]}/api/login`;

      const payload = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, user);

      const response = await axios__WEBPACK_IMPORTED_MODULE_7___default.a.post(url, payload);
      Object(_utils_auth__WEBPACK_IMPORTED_MODULE_8__["handleLogin"])(response.data);
    } catch (error) {
      Object(_utils_catchErrors__WEBPACK_IMPORTED_MODULE_5__["default"])(error, setError);
    } finally {
      setLoading(false);
    }
  }
...
module.exports = __webpack_require__(/*! C:\Users\farha\Desktop\reacttest\pages\login.js */"./pages/login.js");
